...
public class SEM8_PEnMT extends AppCompatActivity implements View.OnClickListener {
    ...
    public SubjectQuadruplet setQuadruplet(String subject){
        SubjectQuadruplet sq = new SubjectQuadruplet("", "", "", "");
        switch (subject){
            case "Micro":
                sq = new SubjectQuadruplet("Micro", "PE8", "Microprocessor & Microcontroller", Urls.microBook);
                break;
            case "MicroLab":
                sq = new SubjectQuadruplet("MicroLab", "PE8", "Microprocessor & Microcontroller Lab", Urls.microBook);
                break;
            case "DCN":
                sq = new SubjectQuadruplet("DCN", "ECE8", "Data Communication & Networks", Urls.dcnBook);
                break;
            }
        return sq;
    }
    ...
    public void setSubjects(String stream){
        if(stream.equals("PE")){
            ...
            mSubjectQuadruplet[12] = setQuadruplet("DCN");
            ...
            mSubjectQuadruplet[3] = new SubjectQuadruplet("RoboticsLab", "PE8",
                    "Robotics Lab", "");
            ...
            mSubjectQuadruplet[10] = new SubjectQuadruplet("VLSI", "8",
                    "VLSI Design",
                    Urls.vlsiBook);
            mSubjectQuadruplet[11] = setQuadruplet("DCN");
