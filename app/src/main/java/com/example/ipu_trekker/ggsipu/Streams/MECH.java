...
//                break;
//            case R.id.it3: intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse(Urls.mechBookList));
//                break;
//            case R.id.it7: intent = new Intent(this,ZChooseSemForSyll.class).putExtra("Stream","MT");
//                break;
