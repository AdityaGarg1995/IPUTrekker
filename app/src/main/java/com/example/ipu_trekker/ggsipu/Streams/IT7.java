...
import static com.example.ipu_trekker.ggsipu.StreamNames.dbms;
...
//                E_B
        ...
        mSubjectQuadruplet[19] = new SubjectQuadruplet("Sociology", "7", sociology, Urls.sociologyBook);
...
//        E_A
                ...
                mSubjectQuadruplet[12] = new SubjectQuadruplet("DBMS", "CE7", dbms, Urls.dbmsBook);
...
//        E_B
                ...
                mSubjectQuadruplet[17] = new SubjectQuadruplet("MIS", "MAE7", "Management Information System & ERP", "");
