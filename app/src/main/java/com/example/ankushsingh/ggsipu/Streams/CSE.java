...
//        Elective-B 7sem
        ...
        a.setTitle("CSE: " + sem + " Semester Subjects");
...
//            E-A
            ...
            case R.id.s1:
                if (sem.equals("8"))
                    intent = new Intent(this, Syllabus.class).putExtra("Subject","OOSE").putExtra("Sem", "CSE8");
                break;
            case R.id.s2:
                if (sem.equals("8"))
                    intent = new Intent(this, Syllabus.class).putExtra("Subject","CV").putExtra("Sem", "CSE8");
                break;
            case R.id.s3:
                if (sem.equals("8"))
                    intent = new Intent(this, Syllabus.class).putExtra("Subject","SPM").putExtra("Sem", "CSE8");
                break;
...
//            E-B
            ...
            case R.id.s4:
                if (sem.equals("8"))
                    intent = new Intent(this, Syllabus.class).putExtra("Subject","TrendCSE").putExtra("Sem", "CSE8");
                break;
        }
