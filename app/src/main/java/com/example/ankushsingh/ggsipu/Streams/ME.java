...
//
//        a.setTitle("Mechanical Engineering");
...
//        switch(v.getId()){
//            case R.id.it2: intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse(Urls.meSyllabus));
//                break;
//            case R.id.it3: intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse(url2));
//                break;
//            case R.id.it7: intent = new Intent(this,ZChooseSemForSyll.class).putExtra("Stream","ME");
//                break;
//            case R.id.it6: intent = new Intent(this,EE2.class).putExtra("StreamName", "ME");
//                break;
//        }
//        if(intent != null)
