package com.example.ankushsingh.ggsipu.Settings;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     * More specifically, when the preference's value is changed,
     * its summary (line of text below the preference title) is updated to reflect the value.
